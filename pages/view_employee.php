...
<script>
	$('#new_allowance').click(function(){
		uni_modal("New Allowace for <?php echo $employee_no.' - '.ucwords($lastname.", ".$firstname." ", $middlename) ?>",'pages/manage_employee_allowances.php?id=<?php echo $_GET['id'] ?>','mid-large')
	})
	$('#new_deduction').click(function(){
		uni_modal("New Deduction for <?php echo $employee_no.' - '.ucwords($lastname.", ".$firstname." ", $middlename) ?>",'pages/manage_employee_deductions.php?id=<?php echo $_GET['id'] ?>','mid-large')
	})
