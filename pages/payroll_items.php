	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#print_btn').click(function(){
				var nw = window.open("pages/print_payroll.php?id=<?php echo $_GET['id'] ?>","_blank","height=500,width=800")
				setTimeout(function(){
					nw.print()
					setTimeout(function(){
						nw.close()
			...
			$('.view_payroll').click(function(){
				...
				uni_modal("Employee Payslip","pages/view_payslip.php?id="+$id,"large")
