	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.edit_attendance').click(function(){
				...
				uni_modal("Edit Employee","pages/manage_attendance.php?id="+$id)
				
			});
			$('.view_attendance').click(function(){
				var $id=$(this).attr('data-id');
				uni_modal("Employee Details","pages/view_attendance.php?id="+$id,"mid-large")
				
			});
			$('#new_attendance_btn').click(function(){
				uni_modal("New Time Record/s","pages/manage_attendance.php",'mid-large')
			})
