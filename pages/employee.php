	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.edit_employee').click(function(){
				...
				uni_modal("Edit Employee","pages/manage_employee.php?id="+$id)
				
			});
			$('.view_employee').click(function(){
				var $id=$(this).attr('data-id');
				uni_modal("Employee Details","pages/view_employee.php?id="+$id,"mid-large")
				
			});
			$('#new_emp_btn').click(function(){
				uni_modal("New Employee","pages/manage_employee.php")
			})
